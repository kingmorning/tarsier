...
curl -o collect.tar.gz http://10.214.129.129:8080/tarsier-manager/collect/download
...
echo "add crontab success, please add config file at URL: http://10.214.129.129:5601 "
exit 0
